...
def search_library(library):
    search_by = input("Enter the search title or author: ").lower()
    ...
    if results:
        for book in results:
            ...
            print(f"{book['title']} by {book['author']} published in {book['year']} - {book['genre']} - {status}")

    else:    
        print(f"No books found '{search_term}' in the {search_by} field")
